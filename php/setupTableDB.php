...
$theQueryT = 'CREATE TABLE IF NOT EXISTS flowerJournal (journalID INTEGER PRIMARY KEY NOT NULL, journalFile TEXT, msg TEXT, msgDate TEXT, user TEXT, growthStage TEXT, growthCompleted TEXT, fID INTEGER, FOREIGN KEY (fID) REFERENCES flowerObjects(flowerID))';
$file_db ->exec($theQueryT);
echo("created flowerJournal table successfully<br>");
